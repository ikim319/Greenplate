...
public class InputMealTest {
    ...
    @Test
    public void testCalorieCounter2_Male() {
        InputMealViewModel viewModel = new InputMealViewModel();
        String height = "71";
        String weight = "150";
        String gender = "Male";
        String result = viewModel.calorieCounter(height, weight, gender);
        assertEquals("Calorie calculation for Male is correct", "2948", result);
    }
    ...
    @Test
    public void testCalorieCounter2_Female() {
        InputMealViewModel viewModel = new InputMealViewModel();
        String height = "60";
        String weight = "110";
        String gender = "Female";
        ...
        assertEquals("Calorie calculation for Female is incorrect", "1279", result);
    }
    ...
    @Test
    public void testCalorieCounter_NonNumericInput_Male() {
        InputMealViewModel viewModel = new InputMealViewModel();
        String height = "abc";
        String weight = "60";
        String gender = "Male";
